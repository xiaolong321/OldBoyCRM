# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2016-01-09 22:09
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('valid_end_time', models.DateTimeField(default=datetime.datetime(2016, 4, 8, 22, 9, 0, 649120, tzinfo=utc))),
            ],
            options={
                'verbose_name': '\u7528\u6237\u4fe1\u606f',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('course', models.CharField(choices=[(b'LinuxL1', 'Linux\u4e2d\u9ad8\u7ea7'), (b'LinuxL2', 'Linux\u67b6\u6784\u5e08'), (b'PythonDevOps', 'Python\u81ea\u52a8\u5316\u5f00\u53d1'), (b'BigDataDev', '\u5927\u6570\u636e\u5f00\u53d1\u8bfe\u7a0b'), (b'Cloud', '\u4e91\u8ba1\u7b97\u8bfe\u7a0b')], max_length=64, verbose_name='\u8bfe\u7a0b\u540d\u79f0')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.CharField(choices=[(b'LinuxL1', 'Linux\u4e2d\u9ad8\u7ea7'), (b'LinuxL2', 'Linux\u67b6\u6784\u5e08'), (b'PythonDevOps', 'Python\u81ea\u52a8\u5316\u5f00\u53d1'), (b'BigDataDev', '\u5927\u6570\u636e\u5f00\u53d1\u8bfe\u7a0b'), (b'Cloud', '\u4e91\u8ba1\u7b97\u8bfe\u7a0b')], max_length=64, verbose_name='\u54a8\u8be2\u8bfe\u7a0b')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('course', models.CharField(choices=[(b'LinuxL1', 'Linux\u4e2d\u9ad8\u7ea7'), (b'LinuxL2', 'Linux\u67b6\u6784\u5e08'), (b'PythonDevOps', 'Python\u81ea\u52a8\u5316\u5f00\u53d1'), (b'BigDataDev', '\u5927\u6570\u636e\u5f00\u53d1\u8bfe\u7a0b'), (b'Cloud', '\u4e91\u8ba1\u7b97\u8bfe\u7a0b')], max_length=64, verbose_name='\u8bfe\u7a0b\u540d')),
                ('class_type', models.CharField(choices=[(b'online', '\u7f51\u7edc\u73ed'), (b'offline_weekend', '\u9762\u6388\u73ed(\u5468\u672b)'), (b'offline_fulltime', '\u9762\u6388\u73ed(\u8131\u4ea7)')], max_length=64, verbose_name='\u73ed\u7ea7\u7c7b\u578b')),
